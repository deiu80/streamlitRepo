...
# Object notation
st.sidebar.write("Select a feature from below:")
...
st.write ("My goal is to develop a model that can accurately identify different emotions such as happiness, sadness, anger, surprise, and disgust from facial images."
...
st.write("The findings from this project can have several practical applications in areas such as psychology, human-computer interaction, and security.")
